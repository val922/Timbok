...
/* /var/www/html/octobercms/themes/ketikidis-emarket/partials/latestProducts/item.htm */
class __TwigTemplate_a8d9dba55cb9aab68bd2a63471197f32fc880478d0031eaf7f79a7c40bbb1f12 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        echo "<div class=\"mall-products-item mx-4\">
    <div class=\"position-relative w-100 max-w-sm mx-auto bg-white\">
        ...
        echo $this->env->getExtension('Cms\Twig\Extension')->partialFunction("latestProducts/image"        , $context['__cms_partial_params']        , true        );
    ...
    {
        return "/var/www/html/octobercms/themes/ketikidis-emarket/partials/latestProducts/item.htm";
    }
    ...
    {
        return new Source("<div class=\"mall-products-item mx-4\">
    <div class=\"position-relative w-100 max-w-sm mx-auto bg-white\">
        <div class=\"position-relative\">
...
</div>", "/var/www/html/octobercms/themes/ketikidis-emarket/partials/latestProducts/item.htm", "");
    }
}
