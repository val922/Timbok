...
/* /var/www/html/octobercms/themes/ketikidis-emarket/partials/wishlistbutton/list.htm */
class __TwigTemplate_a553f356cd267b0f7f4ef0e282b04d2e73996f2b0429093dccd4686792f444fe extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["__SELF__"] ?? null) . "::item")            , $context['__cms_partial_params']            , true            );
    ...
    {
        return "/var/www/html/octobercms/themes/ketikidis-emarket/partials/wishlistbutton/list.htm";
    }
...
{% else %}
    ...
    {% partial __SELF__ ~ '::item'
        product_id=__SELF__.property('product')
        variant_id=__SELF__.property('variant') %}
{% endfor %}", "/var/www/html/octobercms/themes/ketikidis-emarket/partials/wishlistbutton/list.htm", "");
    }
}
