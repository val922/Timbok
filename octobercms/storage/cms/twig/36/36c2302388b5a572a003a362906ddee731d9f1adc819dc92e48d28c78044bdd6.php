...
/* /var/www/html/octobercms/themes/ketikidis-emarket/partials/widgetProducts/stars.htm */
class __TwigTemplate_01dcdff94b863d0f9093e4a856998cdead7d763e26e14a5cffd6139c818661d7 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"mall-category-review__rating line-height-none ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["i"]) {
            ...
            echo $this->env->getExtension('Cms\Twig\Extension')->partialFunction("widgetProducts/star"            , $context['__cms_partial_params']            , true            );
    ...
    {
        return "/var/www/html/octobercms/themes/ketikidis-emarket/partials/widgetProducts/stars.htm";
    }
    ...
    <div class=\"mall-category-review__rating line-height-none {{ clickable ? 'mall-category-review__rating--clickable' }}\">
        {% set rating = rating|round %}
        {% for i in range(1, 5) %}
            {% partial 'widgetProducts/star' active=rating >= i value=i %}
        {% endfor %}
    </div>
    <div class=\"mall-category-review__name text-dark font-5\">
        {{ label }}
    </div>
</div>", "/var/www/html/octobercms/themes/ketikidis-emarket/partials/widgetProducts/stars.htm", "");
    }
}
