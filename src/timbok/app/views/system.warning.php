...
$pageHeader = (new CPageHeader(_('Fatal error, please report to the Timbok team')))
...
(new CTag('main', true,
	new CWarning(_('Fatal error, please report to the Timbok team'), $data['messages'], $buttons)
))->show();
