...
function getSupportUrl($language = null) {
	$urls = [
		'ja' => 'https://www.timbok.com/support',
		'ru' => 'https://www.timbok.com/support',
		'zh' => 'https://www.timbok.com/support'
	];

	return array_key_exists($language, $urls) ? $urls[$language] : 'https://www.timbok.com/support';
}
