...
<html>
	<head>
		...
		<meta name="Author" content="Timbok ACS" />
	...
	<body lang="en">
		<main>
			<div class="<?= ZBX_STYLE_BROWSER_WARNING_CONTAINER ?>">
				...
				<p>Timbok frontend is built on advanced, modern technologies and does not support old browsers. It is highly recommended that you choose and install a modern browser. It is free of charge and only takes a couple of minutes.</p>
