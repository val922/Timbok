...
abstract class DbBackend {
	...
	public function checkDbVersion() {
		...
		if ($version['mandatory'] != ZABBIX_DB_VERSION) {
			$this->setError(_s('The Timbok database version does not match current requirements. Your database version: %1$s. Required version: %2$s. Please contact your system administrator.',
