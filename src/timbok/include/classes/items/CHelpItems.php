	...
	protected function getItems() {
		return [
			ITEM_TYPE_ZABBIX => [
				...
				[
					'key' => 'agent.version',
					'description' => _('Version of Timbok agent. Returns string')
				],
				[
					'key' => 'kernel.maxfiles',
				...
				[
					...
					'description' => _('Returns a JSON object containing Timbok server or proxy internal metrics.')
				],
				[
					'key' => 'zabbix.stats[<ip>,<port>,queue,<from>,<to>]',
					'description' => _('Number of items in the queue which are delayed in Timbok server or proxy by "from" till "to" seconds, inclusive.')
				]
			],
			...
			ITEM_TYPE_AGGREGATE => [
				[
					...
					'description' => _('Aggregate checks do not require any agent running on a host being monitored. Timbok server collects aggregate information by doing direct database queries. See Timbok Manual.')
				]
			],
			ITEM_TYPE_SIMPLE => [
				[
			...
			ITEM_TYPE_INTERNAL => [
				[
					'key' => 'zabbix[boottime]',
					'description' => _('Startup time of Timbok server, Unix timestamp.')
				],
				[
					'key' => 'zabbix[history]',
				...
				[
					...
					'description' => _('Returns a JSON object describing the host network interfaces configured in Timbok. Can be used for LLD.')
				],
				[
				...
				[
					'key' => 'zabbix[items]',
					'description' => _('Number of items in Timbok database.')
				],
				[
					'key' => 'zabbix[items_unsupported]',
					'description' => _('Number of unsupported items in Timbok database.')
				],
				[
					'key' => 'zabbix[java,,<param>]',
					'description' => _('Returns information associated with Timbok Java gateway. Valid params are: ping, version.')
				],
				[
					'key' => 'zabbix[process,<type>,<mode>,<state>]',
					'description' => _('Time a particular Timbok process or a group of processes (identified by <type> and <mode>) spent in <state> in percentage.')
				],
				[
				...
				[
					...
					'description' => _('Required performance of the Timbok server, in new values per second expected.')
				],
				[
					'key' => 'zabbix[stats,<ip>,<port>]',
					'description' => _('Returns a JSON object containing Timbok server or proxy internal metrics.')
				...
				[
					'key' => 'zabbix[triggers]',
					'description' => _('Number of triggers in Timbok database.')
				],
				[
					'key' => 'zabbix[uptime]',
					'description' => _('Uptime of Timbok server process in seconds.')
				],
				[
