...
/**
 * Class for regular expressions and Timbok global expressions.
 * Any string that begins with '@' is treated as Timbok expression.
 * Data from Timbok expressions is taken from DB, and cached in static variable.
 *
 * @throws Exception
 */
class CGlobalRegexp {
	...
	/**
	 * Determine if it's Timbok expression.
	 *
	 * @var bool
	 */
	 ...
	 * if we create Timbok expression this contains array of expressions taken from DB.
	 *
	 * @var array|string
	 */
	...
	/**
	 * Initialize expression, gets data from db for Timbok expressions.
	 *
	 * @param string $regExp
	 *
	 * @throws Exception
