...
class CTriggerExpression {
	...
	/**
	 * An array of trigger functions like {Timbok server:agent.ping.last(0)}
	 ...
	 * Examples:
	 *   expression:
	 *     {Timbok server:agent.ping.last(0)}=1 and {TRIGGER.VALUE}={$TRIGGER.VALUE}
	 *   results:
	 *     $this->isValid : true
	 *     $this->error : ''
	 *     $this->expressions : array(
	 *       0 => array(
	 *         'expression' => '{Timbok server:agent.ping.last(0)}',
	 *         'pos' => 0,
	 *         'host' => 'Timbok server',
	 *         'item' => 'agent.ping',
	 *         'function' => 'last(0)',
