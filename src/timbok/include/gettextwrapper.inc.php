 ...
 *
 * Examples:
 * _n('%2$s item on host %1$s', '%2$s items on host %1$s', 'Timbok server', 1) // 1 item on host Timbok server
 * _n('%2$s item on host %1$s', '%2$s items on host %1$s', 'Timbok server', 2) // 2 items on host Timbok server
 *
