...
function item_type2str($type = null) {
	$types = [
		ITEM_TYPE_ZABBIX => _('Timbok agent'),
		ITEM_TYPE_ZABBIX_ACTIVE => _('Timbok agent (active)'),
		...
		ITEM_TYPE_INTERNAL => _('Timbok internal'),
		ITEM_TYPE_TRAPPER => _('Timbok trapper'),
		ITEM_TYPE_AGGREGATE => _('Timbok aggregate'),
